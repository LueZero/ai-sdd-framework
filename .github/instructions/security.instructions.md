---
description: "Use when reviewing code for security issues, implementing authentication, handling user input, or working with sensitive data. Covers OWASP Top 10 and secure coding practices."
---
