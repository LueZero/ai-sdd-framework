---
description: "Use when designing system architecture, making technology decisions, creating component diagrams, defining interfaces, or writing Architecture Decision Records (ADRs). Expert in software architecture patterns and system design."
